...
class GameChooseClasses extends StatefulWidget {
  const GameChooseClasses(
      {super.key, required this.setClasses, required this.fontSize});
...
class _GameChooseClassesState extends State<GameChooseClasses> {
                        ...
                        for (int i = 0; i < UserClasses.classes.length; i++)
                          Container(
                              ...
                              child: TextButton(
                                  ...
                                  child: Text(UserClasses.fromCode(UserClasses.classesCode.elementAt(i)).name,
  ...
  Widget _buildClasses(
      {required BuildContext context, required UserClass classes}) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Container(
              ...
              child: Text(classes.description)),
          Container(
            margin: const EdgeInsets.only(bottom: 8),
            child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
          ...
          ElevatedButton(
              ...
              child: Ink(
                  ...
                  child: Container(
                    ...
                    constraints:
                        const BoxConstraints(maxWidth: 192, minHeight: 48),
                    padding:
                        const EdgeInsets.symmetric(vertical: 4, horizontal: 6),
                    alignment: Alignment.center,
                    child: Text(
                        AppLocalizations.of(context).chooseClassX(classes.name),
