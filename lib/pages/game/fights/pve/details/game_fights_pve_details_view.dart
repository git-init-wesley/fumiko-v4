...
class _GameFightsPveDetailsView extends State<GameFightsPveDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Consumer<_GameFightsPveDetailsController>(
  ...
  Widget _buildWidget(BuildContext context,
      _GameFightsPveDetailsController controller, Widget? child) {
              ...
              Column(
                  ...
                  children: [
                    ...
                    BarProgressIndicator(
                        value: (controller._actualUser.actualVitality) /
                            widget.user.realVitality,
                        height: 32,
                        width: 128,
                        backgroundColor: Colors.black,
                        foregroundColor: Colors.redAccent,
                        child: Text(
                            '${NumberFormatter.compact(controller._actualUser.actualVitality)}/${NumberFormatter.compact(widget.user.realVitality)}',
                            style: TextStyle(
                                color: Colors.white,
                                fontWeight: FontWeight.bold,
                                fontSize: Theme.of(context)
                        ...
                        child: Text(widget.monster.name,
                            style: TextStyle(
                                ...
                                fontSize: Theme.of(context)
                                    ...
                                    ?.fontSize))),
                    BarProgressIndicator(
                        value: (controller._actualMonster.actualVitality) /
                            widget.monster.realVitality,
                        height: 32,
                        width: 128,
                        backgroundColor: Colors.black,
                        foregroundColor: Colors.redAccent,
                        child: Text(
                            '${NumberFormatter.compact(controller._actualMonster.actualVitality)}/${NumberFormatter.compact(widget.monster.realVitality)}',
                            style: TextStyle(
                                color: Colors.white,
                                fontWeight: FontWeight.bold,
                                fontSize: Theme.of(context)
