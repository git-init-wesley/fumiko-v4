...
class _AuthSignInView extends State<AuthSignInPage>
    with SingleTickerProviderStateMixin {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => widget._createController(),
      child: Consumer<_AuthSignInController>(
  ...
  Widget _buildWidget(
      BuildContext context, _AuthSignInController controller, Widget? child) {
    return Scaffold(
