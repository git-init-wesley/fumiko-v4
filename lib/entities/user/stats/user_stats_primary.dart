...
mixin EntityUserStatsPrimary implements EntityStatsPrimary {
  ...
  EntityUserValue<num?> _strength =
      EntityUserValue<num?>(value: DefaultEntityUserStatsBase.defaultValue);
  ...
  EntityUserValue<num?> _dexterity =
      EntityUserValue<num?>(value: DefaultEntityUserStatsBase.defaultValue);
  ...
  EntityUserValue<num?> _endurance =
      EntityUserValue<num?>(value: DefaultEntityUserStatsBase.defaultValue);
  ...
  Future<void> _getStatsPrimaryValues({required String uid}) async {
    _strength = EntityUserValue<num?>(
        value: (await DatabaseUser.of(uid: uid).getStrength()).value ??
            DefaultEntityUserStatsBase.defaultValue);
    _dexterity = EntityUserValue<num?>(
        value: (await DatabaseUser.of(uid: uid).getDexterity()).value ??
            DefaultEntityUserStatsBase.defaultValue);
    _agility = EntityUserValue<num?>(
        value: (await DatabaseUser.of(uid: uid).getAgility()).value ??
            DefaultEntityUserStatsBase.defaultValue);
    _vitality = EntityUserValue<num?>(
        value: (await DatabaseUser.of(uid: uid).getVitality()).value ??
            DefaultEntityUserStatsBase.defaultValue);
    _endurance = EntityUserValue<num?>(
        value: (await DatabaseUser.of(uid: uid).getEndurance()).value ??
            DefaultEntityUserStatsBase.defaultValue);
    _eyesight = EntityUserValue<num?>(
        value: (await DatabaseUser.of(uid: uid).getEyesight()).value ??
            DefaultEntityUserStatsBase.defaultValue);
    _mass = EntityUserValue<num?>(
        value: (await DatabaseUser.of(uid: uid).getMass()).value ??
            DefaultEntityUserStatsBase.defaultValue);
  }
  ...
  Future<void> _initStatsPrimaryObservers(
      {required String? uid, required Function onChange}) async {
    if (uid == null) return;
    _strengthObserver =
        await DatabaseUser.of(uid: uid).observeStrength((value) async {
      if (value != _strength.value)
        await _strength._set(value ?? DefaultEntityUserStatsBase.defaultValue);
      onChange(null);
      updatePower();
    });
    _dexterityObserver =
        await DatabaseUser.of(uid: uid).observeDexterity((value) async {
      if (value != _dexterity.value)
        await _dexterity._set(value ?? DefaultEntityUserStatsBase.defaultValue);
      onChange(null);
      updatePower();
    });
    _agilityObserver =
        await DatabaseUser.of(uid: uid).observeAgility((value) async {
      if (value != _agility.value)
        await _agility._set(value ?? DefaultEntityUserStatsBase.defaultValue);
      onChange(null);
      updatePower();
    });
    _vitalityObserver =
        await DatabaseUser.of(uid: uid).observeAgility((value) async {
      if (value != _vitality.value)
        await _vitality._set(value ?? DefaultEntityUserStatsBase.defaultValue);
      onChange(null);
      updatePower();
    });
    _enduranceObserver =
        await DatabaseUser.of(uid: uid).observeAgility((value) async {
      if (value != _endurance.value)
        await _endurance._set(value ?? DefaultEntityUserStatsBase.defaultValue);
      onChange(null);
      updatePower();
    });
    _eyesightObserver =
        await DatabaseUser.of(uid: uid).observeAgility((value) async {
      if (value != _eyesight.value)
        await _eyesight._set(value ?? DefaultEntityUserStatsBase.defaultValue);
      onChange(null);
      updatePower();
    });
    _massObserver =
        await DatabaseUser.of(uid: uid).observeAgility((value) async {
      if (value != _mass.value)
        await _mass._set(value ?? DefaultEntityUserStatsBase.defaultValue);
      onChange(null);
      updatePower();
    });
  }
