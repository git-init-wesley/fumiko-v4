...
mixin _DatabaseUserLeveling {
  ...
  Future<DatabaseResult<num?>> getLevels() async => await getValue<num?>(path: DatabaseUserLevelingPaths.levels(uid));

  Future<DatabaseResult<num?>> setLevels(num? newLevels) async => await setValue<num?>(path: DatabaseUserLevelingPaths.levels(uid), value: newLevels);
  ...
  Future<DatabaseResult<num?>> getRebirths() async => await getValue<num?>(path: DatabaseUserLevelingPaths.rebirths(uid));

  Future<DatabaseResult<num?>> setRebirths(num? newRebirths) async => await setValue<num?>(path: DatabaseUserLevelingPaths.rebirths(uid), value: newRebirths);
  ...
  Future<DatabaseResult<num?>> getExp() async => await getValue<num?>(path: DatabaseUserLevelingPaths.exp(uid));

  Future<DatabaseResult<num?>> setExp(num? newExp) async => await setValue<num?>(path: DatabaseUserLevelingPaths.exp(uid), value: newExp);
