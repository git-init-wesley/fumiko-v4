...
class AuthExceptions {
  ...
  static List<AppException> get authErrors => [userNotFound(), userDisabled(), tooManyRequests(), invalidEmail(), emailAlreadyInUse(), wrongPassword(), usernameAlreadyTaken()];
  ...
  static AppException tooManyRequests() => AppException(code: 'too-many-requests', message: 'The instance cannot be validated or is invalid.');
