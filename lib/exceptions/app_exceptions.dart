...
class AppExceptions {
  ...
  static List<AppException> get errors =>
      baseErrors +
      AuthExceptions.authErrors +
      DatabaseExceptions.databaseErrors;
  ...
  static AppException passwordNotEqual({Object? object}) => AppException(
      code: 'malformed/password-not-equal',
      message: 'Passwords are not equal.',
      object: object);

  static bool isBaseErrors(AppException exception) =>
      baseErrors.contains(exception);

  static bool isAuthErrors(AppException exception) =>
      AuthExceptions.authErrors.contains(exception);

  static bool isDatabaseErrors(AppException exception) =>
      DatabaseExceptions.databaseErrors.contains(exception);
}
