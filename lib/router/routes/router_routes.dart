...
class RouterRoutes {
  ...
  static const RouterRoute _authSignIn = RouterRoute(
      name: 'Authentication Sign In',
      route: '/auth/sign-in',
      createPage: AuthSignInPage());

  static RouterRoute get authSignIn => _authSignIn;

  static const RouterRoute _authSignUp = RouterRoute(
      name: 'Authentication Sign Up',
      route: '/auth/sign-up',
      createPage: AuthSignUpPage());

  static RouterRoute get authSignUp => _authSignUp;

  static const RouterRoute _authRecovery = RouterRoute(
      name: 'Authentication Recovery',
      route: '/auth/recovery',
      createPage: AuthRecoveryPage());

  static RouterRoute get authRecovery => _authRecovery;

  static const RouterRoute _gameMain = RouterRoute(
      name: 'Game Main', route: '/game/main', createPage: GameMainPage());
  ...
  static List<RouterRoute> get authenticationRoutes =>
      [authSignIn, authSignUp, authRecovery];
  ...
  static List<RouterRoute> get routes =>
      ...
      gameRoutes; // + authenticationRoutes + gamesRoutes;
  ...
  static bool isAuthenticationRoutes(RouterRoute routes) =>
      authenticationRoutes.contains(routes);
